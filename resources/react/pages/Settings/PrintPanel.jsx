...
export default function PrintPanel({
    ...
    const generateOptions = [
        ...
        {
            label: "Generate barcode for all selected products or variants. If products or variants don't have barcode value, generate new barcode data. If products or variants already have barcode value, replace the old value with new one",
            value: 'replace',
        },
        {
            label: 'Generate barcode for all selected products or variants. If products or variants do not have barcode value, using products SKU attribute for generating barcode',
            value: 'sku',
        },
        {
        ...
        <s-section>
            <s-stack direction="block" gap="base">
                    ...
                    <s-text-field
                        ...
                        value={
                            settings.default_print_label_quantity !== undefined
                                ? String(
                                    settings.default_print_label_quantity
                                )
                                : '1'
                        }
                        onInput={(e) => {
                ...
                <s-checkbox
                    ...
                    checked={
                        settings.hide_product_archived
                            ? true
                            : undefined
                    }
                    onChange={(e) =>
                ...
                <s-checkbox
                    ...
                    checked={
                        settings.use_shopify_flow_action
                            ? true
                            : undefined
                    }
                    onChange={(e) =>
