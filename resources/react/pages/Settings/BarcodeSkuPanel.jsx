        ...
        async function fetchSettings() {
            try {
                ...
                if (data.success && data.settings) {
                    onChange(
                        'barcode_format',
                        data.settings.barcode_format || 'CODE128'
                    );

                    onChange(
                        'barcode_pattern',
                        data.settings.barcode_pattern || ''
                    );

                    onChange(
                        'contextual_pricing_value',
                        data.settings.contextual_pricing_value || ''
                    );

                    onChange(
                        'auto_generate_on_create',
                        !!data.settings.auto_generate_on_create
                    );

                    onChange(
                        'auto_detect_gtin_format',
                        !!data.settings.auto_detect_gtin_format
                    );

                    onChange(
                        'prevent_zero_start_end',
                        !!data.settings.prevent_zero_start_end
                    );
                }
            } catch (error) {
        ...
        <s-stack direction="block" gap="loose">
            ...
            >
                ...
                >
                    ...
                    >
                        Control when your app auto-creates or alters newly indexed barcodes.
                    </p>
                </s-stack>
                ...
                <s-section>
                    ...
                    >
                        ...
                        <s-checkbox
                            ...
                            checked={
                                settings.auto_detect_gtin_format
                                    ? true
                                    : undefined
                            }
                            onChange={(e) =>
                        ...
                        <s-checkbox
                            ...
                            checked={
                                settings.prevent_zero_start_end
                                    ? true
                                    : undefined
                            }
                            onChange={(e) =>
            ...
            >
                ...
                >
                    ...
                    >
                        Define specific output patterns, value variants, and label styles.
                    </p>
                </s-stack>
                ...
                <s-section>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                Used to generate barcodes. For example:
                            </p>
