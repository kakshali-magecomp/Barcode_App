...
export default function DesignCanvasEdit({
            ...
            if (
                ...
                const selected =
                    products.variants.find(
                        (item) =>
                            item.variant_id === savedVariantId
                    ) || products.variants[0];
    ...
    const handlePrint = () => {
        ...
        if (!paper) {
            shopify.toast.show(
                "Please select a brand and paper model for printing.",
                {
                    duration: 5000,
                    isError: true,
                }
        ...
        if (
            ...
            shopify.toast.show(
                "Invalid paper template. Please select a valid paper model.",
                {
                    duration: 5000,
                    isError: true,
                }
