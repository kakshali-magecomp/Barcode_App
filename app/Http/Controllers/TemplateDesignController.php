    ...
    public function show($template_id)
    {
        try {
            ...
            $design = TemplateDesign::firstOrCreate(
                ...
                [
                    'barcode_format' => $barcodeSettings->barcode_format ?? 'CODE128',
                    'margin_top' => 5,
                    'margin_bottom' => 5,
                    'margin_left' => 5,
                    'margin_right' => 5,
                    ...
                    'line2_name' => true,
                    'line2_price' => true,
                    'line2_currency_format' => '${{amount}}',
                    'line2_show_price_per_unit' => false,
                    'line2_variant_option1' => true,
                    'line3_vendor' => false,
                    'symbol_enabled' => true,
                    'symbol_type' => 'QR',
                    'symbol_color' => '#000000',
                    'symbol_field_source' => 'barcode_value',
                    'hide_barcode_value' => false,
                    'symbol_font_size' => 12,
                    'symbol_bar_width' => 2,
                    'symbol_bar_height' => 35,
                    'symbol_width_px' => '140',
                    'symbol_margin_px' => '1',
                    'qr_dot_type' => 'square',
            ...
            Log::info("TEMPLATE DESIGN", $design->toArray());
            Log::info("FINAL RESPONSE", $responsePayload);
    ...
    public function update(Request $request, $template_id)
    {
        try {
            ...
            $fieldsPayload = [
                ...
                'barcode_format' => (string) ($incoming['barcode_format'] ?? 'CODE128'),
